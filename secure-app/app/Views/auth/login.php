<?= $this->include('templates/header', ['title' => 'Login - MDK Alliance']) ?>
...
<div class="glass-panel p-8 md:p-12 rounded-2xl shadow-2xl max-w-md w-full relative z-10 mx-4">
    ...
    <div class="mb-8 text-center">
        ...
        <p class="text-slate-400 text-sm mt-2">Enter your credentials to access the portal.</p>
    </div>
    ...
    <form action="/login/authenticate" method="POST" class="space-y-4">
        ...
        <div>
            <div class="flex justify-between items-center mb-2">
                <label class="block text-slate-300 text-sm font-bold">Password</label>
                <a href="/forgot-password" class="text-sm text-amber-400 hover:text-amber-300 transition-colors">Forgot password?</a>
            </div>
    ...
    <div class="mt-6 text-center">
        <a href="/register" class="text-sm text-slate-400 hover:text-amber-400 transition-colors">
            New warrior? Apply for access here
        </a>
    </div>
</div>
